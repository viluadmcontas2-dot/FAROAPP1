...
- [ ] B2 — Vercel target identificado/configurado sem production deploy prematuro. IN PROGRESS: team identificado; falta importar `FAROAPP1` como projeto `faro-financeiro` e fazer readback do projeto.
- [x] B3 — Build provider-neutral validado para o hosting/runtime alvo: `vercel.json` + `npm run check` + `npm run build` + auditoria `_site` verdes no run `33333535649`.
...
Evidence B3: `docs/evidence/FARO-WU-002-vercel-runtime-contract-receipt.md`.
