...
contains(platform, 'É rápido e você só faz isso uma vez.', 'Instalação precisa parecer uma etapa simples');
contains(platform, 'Acesso rápido', 'Benefício precisa usar linguagem de produto');
contains(platform, 'Instalação única', 'Benefício precisa reforçar que é uma única etapa');
...
console.log('FARO: instalação obrigatória com linguagem simples, tutorial por dispositivo e abertura standalone — ok');
