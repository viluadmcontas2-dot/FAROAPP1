...
assert.match(sw, /const CORE_CACHE = 'faro-v1-core-18'/, 'Correções físicas precisam invalidar o cache anterior');
...
console.log('FARO físico: atualização silenciosa preservada e cache 18 renovado — ok');