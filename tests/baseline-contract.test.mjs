...
for (const source of [sw, await read('_site/sw.js')]) {
  assert.match(source, /faro-v1-core-23/);
  assert.match(source, /faro-platform\.js\?v=3/);
  assert.match(source, /faro-update\.js\?v=1/);
  assert.match(source, /faro-brand-r2\.js\?v=1/);
  assert.match(source, /faro-home-r2\.js\?v=2/);
  assert.match(source, /faro-register-earnings\.js\?v=1/);
  assert.match(source, /faro-register\.js\?v=3/);
  assert.match(source, /faro-interactions\.js\?v=2/);
  assert.match(source, /faro-planning\.js\?v=2/);
  assert.match(source, /faro-r3b\.js\?v=1/);
  assert.match(source, /faro-r3-routing\.js\?v=3/);
  assert.match(source, /faro-tour\.js\?v=2/);
  assert.match(source, /faro-r2-polish\.js\?v=2/);
  assert.match(source, /assets\/platforms\/faro-platform-99\.svg/);
  assert.match(source, /assets\/platforms\/faro-platform-indrive\.svg/);
  assert.match(source, /assets\/platforms\/faro-platform-uber\.svg/);
...
for (const path of ['faro-brand-r2.js','faro-home-r2.js','faro-register-earnings.js','faro-register.js','faro-interactions.js','faro-planning.js','faro-planning-invariants.js','faro-r3b.js','faro-r3-routing.js','faro-tour.js','faro-r2-polish.js','faro-platform.js','faro-update.js','faro-state.js','faro-energy.js','faro-onboarding.js','sw.js','app-shell.html','assets/platforms/faro-platform-99.svg','assets/platforms/faro-platform-indrive.svg','assets/platforms/faro-platform-uber.svg']) {
...
console.log('FARO físico: núcleo financeiro e shell legado intactos; cache 23 e geração premium propagados no build — ok');
