...
// Reset fica isolado da operação diária.
...
console.log('FARO: navegação humana, Histórico acessível, retorno contextual, Planejar coerente e Radar fora da superfície v1 — ok');
